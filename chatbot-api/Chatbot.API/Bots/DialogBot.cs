...
namespace Microsoft.BotBuilderSamples
{
    public class DialogBot<T> : ActivityHandler where T : Dialog
    {
        ...
        public override async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await _helper._conversationState.SaveChangesAsync(turnContext, false, cancellationToken);
            await _helper._userState.SaveChangesAsync(turnContext, false, cancellationToken);
        }
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            if (!string.IsNullOrWhiteSpace(conversation?.UserPreference?.UserOption))
            {
                ...
                await _dialog.Run(turnContext, _helper._conversationState.CreateProperty<DialogState>(nameof(DialogState)), cancellationToken);
            }
            else
            {
